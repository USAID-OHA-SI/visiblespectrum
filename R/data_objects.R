#' All Countries Data
#'
#' A dataset containing the names of all countries.
#'
...
#' All Indicators Data
#'
#' A dataset containing the names of all indicators.
#'
...
#'
#' A dataset containing the names of all indicators and their respective codes
#' used to create URLs on the website.
#'
...
#'
#' A dataset containing the maximum levels for each country.
#'
